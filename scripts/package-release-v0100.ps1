...
$ChecksumPath = Join-Path $DistRoot 'SHA256SUMS-v0.10.0-windows.txt'
...
# -- it points at scripts\download-*.bat, and the packager copies those scripts to the archive root
...
Copy-Item -LiteralPath (Join-Path $RepoRoot 'RELEASE_NOTES_0.10.0.md') -Destination $ProductRoot
