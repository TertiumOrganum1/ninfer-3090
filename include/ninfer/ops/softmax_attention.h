 ...
 * FP32(c) * FP32(scale_bits). rk4v4-e8 stores V exactly as rk8v4 and K as packed signed 4-bit
 * codes in the same nibble order, one FP16 scale per 64-value group. A causal FP8-E4M3FN V row has one stored FP16 scale for D256;
